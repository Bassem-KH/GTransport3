 ...
 class VehiculePersennelle {
  ...
  /**
    ...
    private $Disponibilite;
     ...
     /**
     *@ORM\ManyToOne(targetEntity="PPE\GeParcBundle\Entity\Parc",inversedBy="vehiculepersennelle")
    ...
    function setNomDuResponsable($NomDuResponsable) {
